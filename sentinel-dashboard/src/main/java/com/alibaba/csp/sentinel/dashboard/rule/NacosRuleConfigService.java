 ...
 * @author lzhpo
 */
public class NacosRuleConfigService implements RuleConfigService {

    private static final Logger LOGGER = LogUtils.logger(NacosRuleConfigService.class);
    ...
    public NacosRuleConfigService(Properties properties) throws NacosException {
    ...
    public boolean publishConfig(String dataId, String group, String content) throws NacosException {
        return publishConfigInner(namespace, dataId, group, null, null, null, content, ConfigType.TEXT.getType());
    }
