...
public class GatewayFlowRuleController implements BaseRulesController<GatewayFlowRuleEntity, Long> {
    ...
    @Autowired
    private StoreRuleApiClient<GatewayFlowRuleEntity> storeRuleApiClient;
